    ...
    return BottomAppBar(
      ...
      child: Padding(
        ...
        child: Row(
          ...
          children: [
            // Zeit- & Distanzinformationen
            Expanded(
              flex: 2, // ggf. anpassen für Breitenverhältnis
              child: Row(
                children: [
                  Column(
                    children: [
                  ...
                  SizedBox(width: UIStyle.contentMarginHuge),
                  Column(
                    children: [
                      Text(
            ...
            // RouteProgress daneben
            Expanded(
              flex: 1, // weniger Platz
              child: Container(
                height: 60, // feste Höhe oder passend machen
