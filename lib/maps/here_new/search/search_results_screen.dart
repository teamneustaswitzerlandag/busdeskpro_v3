...
class _SearchResultsScreenState extends State<SearchResultsScreen> with TickerProviderStateMixin, Positioning {
  ...
  void _createResultsMarkers() {
    ...
    _smallMarkerImage = MapImage.withFilePathAndWidthAndHeight("lib/assets/map_marker.svg", markerSize, markerSize);
    _bigMarkerImage =
        MapImage.withFilePathAndWidthAndHeight("lib/assets/map_marker_big.svg", markerSize * 2, markerSize * 2);
    _markers = <MapMarker>[];
