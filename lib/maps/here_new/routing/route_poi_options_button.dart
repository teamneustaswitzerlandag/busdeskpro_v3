...
final List<_PoiSettingInfo> _poiSettings = [
  _PoiSettingInfo(
    ...
    imageEnabled: "lib/assets/eat_and_drink_icon.svg",
    imageDisabled: "lib/assets/eat_and_drink_icon_disabled.svg",
    icon: Icons.restaurant_rounded,
  ),
  _PoiSettingInfo(
    categoryId: PlaceCategory.businessAndServicesFuelingStation,
    imageEnabled: "lib/assets/fueling_station_icon.svg",
    imageDisabled: "lib/assets/fueling_station_icon_disabled.svg",
    icon: Icons.local_gas_station_rounded,
  ),
  _PoiSettingInfo(
    categoryId: PlaceCategory.businessAndServicesAtm,
    imageEnabled: "lib/assets/atm_icon.svg",
    imageDisabled: "lib/assets/atm_icon_disabled.svg",
