...
import '../common/extensions/error_handling/routing_error_extension.dart';
...
class _RoutingScreenState extends State<RoutingScreen> with TickerProviderStateMixin, Positioning, RouteAware {
            ...
            child: InkWell(
              child: Padding(
                ...
                child: SvgPicture.asset(
                  appPreferences.showTrafficLayers ? "lib/assets/traffic_off.svg" : "lib/assets/traffic_on.svg",
          ...
          Row(
            ...
            children: [
              ...
              TextButton(
                ...
                onPressed: () {
                  _wayPointsController.insert(2, WayPointInfo(coordinates: GeoCoordinates(53.0511652, 8.635843)));
                  _wayPointsController.removeAt(1);
                } //_awaitOptionsFromPreferenceScreen(context),
              ),
            ],
          ),
          if (_routes.isNotEmpty)
                      ...
                      (route) => Card(
                        ...
                        child: RouteInfo(
                          ...
                          onNavigation: () => Navigator.of(context).pushNamed(
                            ...
                            arguments: [route, _wayPointsController.value, nextStepHandler],
                          ),
                        ),
                      ),
                    )
  ...
  _onRoutingEnd(Routing.RoutingError? error, List<Routing.Route>? routes) {
    ...
    if (widget.startNavigationDirectly) {
      if (_routes.length > 0) {
        routeWaypointController =_wayPointsController;
        Navigator.of(context).pushNamed(
          NavigationScreen.navRoute,
          arguments: [_routes[0], _wayPointsController.value, nextStepHandler],
        );
      }
    }
  }
