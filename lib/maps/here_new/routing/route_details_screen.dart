...
import '../common/extensions/geo_box_extensions.dart';
...
class _RouteDetailsScreenState extends State<RouteDetailsScreen> {
  ...
  void _addRouteToMap() {
    ...
    MapImage mapImage = MapImage.withFilePathAndWidthAndHeight("lib/assets/maneuver.svg", _markerSize, _markerSize);
    widget.route.sections.forEach((section) {
...
extension _ManeuverImagePath on Routing.ManeuverAction {
  String get imagePath {
    return "lib/assets/maneuvers/dark/" + toString().split(".").last + ".svg";
  }
}
